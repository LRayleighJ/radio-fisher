...
expt_list = [
    ...
    ( 'FASThighzshift',           e.FASThighZLbandshift),         # 98
]
...
params_name_read = None
params_name_value = None
lbl_name = None

if len(sys.argv) > 1:
    k = int(sys.argv[1])
    try:
        params_name_read  = str(sys.argv[2])
        params_name_value = np.float64(sys.argv[3])
        lbl_name = str(sys.argv[4])
    except:
        params_name_read = None
        params_name_value = None
        lbl_name = None
...
if params_name_read:
    expt[params_name_read] = params_name_value

if lbl_name:
    lbl_name = "_"+lbl_name
    survey_name += lbl_name
