...
mpirun -n $NCPU python ./full_experiment.py 0
mpirun -n $NCPU python ./full_experiment.py 1
mpirun -n $NCPU python ./full_experiment.py 2

# Run forecast for DETF IV reference model
mpirun -n $NCPU python ./galaxy_full_experiment.py 1

# Run forecasts for Facility ref. model with different distance measures 
# turned on and off
mpirun -n $NCPU python ./scan_distance_measures.py 2
...
python ./plotting/plot_Veff.py

# Fig. 3: fig03-resolution-z.pdf
python ./plotting/plot_resolution_redshift.py

# Fig. 4: fig04-dlogp.pdf
python ./plotting/plot_dlogp.py

# Fig. 5: fig05-fbao.pdf
python ./plotting/plot_fbao.py

# Fig. 6: fig06-zfns.pdf
python ./plotting/plot_all_redshift_functions.py

# Fig. 7: fig07-dlogp-fnz.pdf
python ./plotting/plot_dlogp_fnz.py

# Fig. 8: fig08-zfns-distance-measures.pdf
python ./plotting/plot_redshift_functions_different_distance_measures.py

# Fig. 9: fig09-lss-distances.pdf
python ./plotting/plot_lss_distances.py

# Fig. 10: fig10-fs8-bs8.pdf
python ./plotting/plot_fs8_bs8.py

# Fig. 11: fig11-5params.pdf
python ./plotting/plot_triangle_6params.py

# Fig. 12: fig12-w0wa-with-without-ok.pdf
python ./plotting/plot_w0wa_with_without_curvature.py

# Fig. 13: fig13-w0omegaDE-okfixed.pdf
python ./plotting/plot_omegaDEw0.py

# Fig. 14: fig14-fom-improvement.pdf
python ./plotting/plot_omegak_improvement.py

# Fig. 15: fig15-ok-improvement.pdf
python ./plotting/plot_omegak_improvement.py

# Fig. 16: fig16-ok.pdf
python ./plotting/plot_1d_omegak.py

# Fig. 17: fig17-6params-eos.pdf
python ./plotting/plot_triangle_5eosparams.py

# Fig. 18: fig18-gamma-improvement.pdf
python ./plotting/plot_omegak_improvement.py

# Fig. 19: fig19-w0gamma.pdf
python ./plotting/plot_w0gamma.py

# Fig. 20: fig20-omegaHI-evol.pdf
python ./plotting/plot_omegaHI_data.py

# Fig. 21: fig21-omegaHI.pdf
python ./plotting/plot_expt_parameter_scan_multipanel.py 3

# Fig. 22: fig22-signl.pdf
python ./plotting/plot_expt_parameter_scan_multipanel.py 5

# Fig. 23: fig23-efg.pdf
python ./plotting/plot_expt_parameter_scan_multipanel.py 2

# Fig. 24: fig24-kfg.pdf
python ./plotting/plot_expt_parameter_scan_multipanel.py 4

# Fig. 25: fig25-ttot.pdf
python ./plotting/plot_expt_parameter_scan_multipanel.py 0

# Fig. 26: fig26-sarea.pdf
python ./plotting/plot_expt_parameter_scan_multipanel.py 1

# Fig. 27: fig27-dlogp-ideal.pdf
python ./plotting/plot_ideal_dlogp.py

# Fig. 28: fig28-w0wa-combined.pdf
python ./plotting/plot_w0wa_combined.py

# Fig. 29: fig29-pk-lowk.pdf
python ./plotting/plot_pk.py

# Fig. 30: fig30-beams.pdf
python ./plotting/plot_beams.py
